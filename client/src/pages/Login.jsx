      ...
      <div className="shadow-2xl rounded style='background-color: #394f62;'">
        <div className="flex min-h-full flex-col justify-center px-6 lg:px-8 mt-5">
          <div className="sm:mx-auto sm:w-full sm:max-w-sm ">
            <h2 className="mt-10 text-center text-2xl font-bold leading-9 tracking-tight text text-white">
              Zaloguj się
            </h2>
          </div>
          <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm space-y-6">
            <div>
              <label
                htmlFor="email"
                className="block text-sm text-white font-medium leading-6 text"
              >
                E-Mail
              </label>
              <div className="mt-2">
            ...
            <div>
              <div className="flex items-center justify-between">
                <label
                  htmlFor="password"
                  className="block text-sm font-medium leading-6 text text-white"
                >
                  Hasło
                </label>
